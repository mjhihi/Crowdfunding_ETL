...
This project involves constructing an ETL (Extract, Transform, Load) pipeline utilizing Python, Pandas, and Python dictionary methods to extract and transform data. Following transformation, the data is segmented into four CSV files and subsequently uploaded into a Postgres database. Below, the procedure details of the ETL pipeline are outlined.
